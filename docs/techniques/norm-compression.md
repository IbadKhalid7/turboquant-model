...
|------|----------|-------------|
| `norm_compression.py` | `factorize_norms()` | Rank-1 SVD + int8 residual quantization |
| `norm_compression.py` | `reconstruct_norms()` | Reconstruct norms from factored form |
| `norm_compression.py` | `norm_bpw()` | Compute BPW overhead for different methods |
